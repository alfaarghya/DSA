class DoublyLinkedList {
  ...
  public static Node head; //head is the first Node of DoublyLinkedList
  public static Node tail; //tail is the last Node of DoublyLinkedList
  ...
  public void addWithIndex(int index, int data) { //TC -> O(n)
