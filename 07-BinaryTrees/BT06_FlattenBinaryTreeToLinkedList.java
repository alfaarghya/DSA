...
class Solution2 {
  ...
  private TreeNode prev = null; // keep tack what has already flattened

  // reverse the preorder traversal completly
  public void flatten(TreeNode root) {
    if (root == null) {
      return;
    }
...
public class BT06_FlattenBinaryTreeToLinkedList {
